...
double GamePak::getTimeElapsedSinceLastFrame()
{
  return timer.time_since_last_frame ;
}

double GamePak::getTimeElapsedSinceGameStart()
{
...
void GamePak::addCallback( Callback *callback )
{
...
void GamePak::addCallbackAbsolute( Callback *callback )
{
