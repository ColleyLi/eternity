...
// You can use this Visual Studio project
// as a STARTING POINT for your own project.

// I highly recommend you DO NOT edit this file,
// instead Create a NEW Visual Studio project,
// if you're not sure how, ASK, its easy!
