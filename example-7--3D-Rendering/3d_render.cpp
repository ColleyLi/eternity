...
void Draw()
{
  ...
  window->createTriVC(
    VertexC( 0, 0, 0, 255, 0, 0 ),
    VertexC( 0, 5, 0, 0, 255, 0 ),
    VertexC( -5, 5, 0, 0, 0, 255 )
  ) ;

  window->createQuadVC(

    VertexC( 1.2f, 0.5f, 1, 255, 255, 255 ),
    VertexC( 5, 0, 1, 0, 255, 0 ),
    VertexC( 2.5, 5, 1, 0, 255, 255 ),
    VertexC( 0, 5, 1, 0, 0, 255 )
